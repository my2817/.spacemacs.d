...
(defun my-config/init-plantuml-mode()
  (use-package plantuml-mode
    ...
    :config
    (progn
      (setq plantuml-indent-regexp-end (concat "^[ \t]*\\(?:@enduml"
                                               "\\|end\s+fork"
                                               "\\|fork\s+again"
                                               "\\|end\s+note"
                                               "\\|endif"
                                               ...
                                               "\\|stop"
                                               "\\|}\\)"))
      (setq plantuml-indent-regexp-start (concat "^[ \t]*\\(?:@startuml"
                                                 "\\|fork\s+again"
                                                 "\\|fork"
                                                 "\\|start"
                                                 "\\|if"
                                                 ...
                                                 "\\|top\\)\\)\\)\\(?:\s+of\\)?"
                                                 "\\|.*{\\)"))
      (defvar plantuml-indent-regexp-arrow (concat "^[ \t]*\\(?:\\(?:<"
                                                   "\\|<|"
                                                   "\\|o"
                                                   "\\|\\*\\)\\(?:\\."
                                                   "\\|-\\)\\(?:down"
                                                   ...
                                                   "\\|\\*"
                                                   "\\|o\\)\\)"))
      (defvar plantuml-indent-regexp-arrow-1 (concat "\\(?:\\(?:<"
                                                     "\\|<|"
                                                     "\\|o"
                                                     "\\|\\*\\)\\(?:\\."
                                                     "\\|-\\)\\(?:down"
                                                     ...
                                                     "\\|\\*"
                                                     "\\|o\\)\\)"))
      (defvar plantuml-indent-regexp-arrow-2 (concat "^\s*.+\s+\\(?:\\(?:<"
                                                     "\\|<|"
                                                     "\\|o"
                                                     "\\|\\*\\)\\(?:\\."
                                                     "\\|-\\)\\(?:down"
